...
public:
    ...
    int tts(const std::string &text, const std::vector<unsigned short> &prompt_text_embeds,
            const std::vector<unsigned short> &prompt_speech_embeds, const std::vector<float> &prompt_feat,
